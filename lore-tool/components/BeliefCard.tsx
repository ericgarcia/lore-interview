...
import type { BeliefObject } from "@/lib/types";
...
export function BeliefCard({ belief, highlighted, onClick }: Props) {
  return (
    <button
      onClick={onClick}
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2 mb-2">
        ...
        <span className="ml-auto text-xs text-[#6b7280] tabular-nums">
          ...
          {belief.confidence != null && <>{" · "}conf {belief.confidence.toFixed(2)}</>}
        </span>
      </div>
